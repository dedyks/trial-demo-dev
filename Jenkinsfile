node {
    ...
    [
        parameters(
            ...
            string(defaultValue: 'trial-demo-dev-key', description: '', name: 'CREDENTIALS_ID'),
            ...
            string(defaultValue: ':1.0.0', description: '', name: 'IMAGE_VERSION'),
            string(defaultValue: 'us-central1-a', description: '', name: 'LOCATION')
